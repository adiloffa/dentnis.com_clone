...
Route::get('contact-messages', [\App\Http\Controllers\Admin\AdminController::class, 'show_message'])->name('show-message');
Route::delete('contact-message-delete/{id}', [\App\Http\Controllers\Admin\AdminController::class, 'delete_message'])->name('comment-delete');
});
